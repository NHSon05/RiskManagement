              ...
              <FormField control={form.control} name="prj_role" render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="investor" className="bg-white hover:bg-(--border)">Chủ đầu tư</SelectItem>
                      <SelectItem value="contractor" className="bg-white hover:bg-(--border)">Nhà thầu</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
